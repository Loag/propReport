...
var default_options = {
	...
	var _parse_input = parse_input(text),
	    ...
	    extension = _parse_input.extension;
...
function parse_phone_uri_input(text) {
	...
	try {
		for (var _iterator2 = (0, _getIterator3.default)(text.split(';')), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
