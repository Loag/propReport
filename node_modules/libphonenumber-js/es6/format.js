...
var default_options = {
	...
	switch (format_type) {
		case 'International':
			...
			var national_number = format_national_number(number, 'International', false, metadata);
			var international_number = '+' + metadata.countryCallingCode() + ' ' + national_number;
		...
		case 'National':
			...
			var _national_number = format_national_number(number, 'National', false, metadata);
			if (input.ext || input.ext === 0) {
